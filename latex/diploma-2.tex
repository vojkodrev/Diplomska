...
Za svetlo temno mejo vzamemo prevojno točko na grafu. Ta točka se nahaja kjer je drugi odvod funkcije 0. Za izračun drugega odvoda uporabimo formulo \ref{eq:d2} \cite{second-d}.
...
\bibitem{hough} (2012) Aforge.Net Hough-jeva transformacija. Dostopno na: 
...
\bibitem{oreilly-dp} Eric Freeman, Elisabeth Robson, Bert Bates, Kathy Sierra, Head First Design Patterns, O'Reilly, 2004, ISBN:978-0-596-00712-6 | ISBN 10:0-596-00712-4

\bibitem{oreilly-cs} Andrew Stellman, Jennifer Greene, Head First C\#, O'Reilly, 2007, ISBN:978-0-596-51482-2 | ISBN 10:0-596-51482-4

\bibitem{hough-wiki} Shapiro, Linda and Stockman, George. "Computer Vision", Prentice-Hall, Inc. 2001

\bibitem{sobel-wiki} K. Engel (2006). Real-time volume graphics,. pp. 112–114.

\bibitem{treshold-wiki} Gonzalez, Rafael C. \& Woods, Richard E. (2002). Thresholding. In Digital Image Processing, pp. 595–611. Pearson Education. ISBN 81-7808-629-8

\bibitem{second-d} (2012) Finite difference, Wikipedia. Dostopno na:\\ 
http://en.wikipedia.org/wiki/Finite\_difference

\bibitem{RGB} Charles A. Poynton (2003). Digital Video and HDTV: Algorithms and Interfaces. Morgan Kaufmann. ISBN 1558607927.
